...
public class Prepass : MonoBehaviour {
	...
	/*
	 * Find all object with Tag glowable and render each pixel of that object with a color
	*/
	void SetUpPrepass ()
	{
		...
		camera.SetReplacementShader (Shader.Find ("Hidden/GlowReplace"), "Glowable");
